...
const About: React.FC = () => (
  ...
  <section className="rounded-xl bg-white/20 backdrop-blur-md shadow-lg w-full max-w-4xl mx-auto md:mx-4 py-12 flex flex-col items-center text-white mb-8 px-4">
    <div className="flex flex-col items-center gap-4 w-full">
      ...
      <h2 className="text-lg font-medium text-blue-200 text-center mb-2 flex items-center gap-2">
